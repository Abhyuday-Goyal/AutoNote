...
def convert(latex_content = r''''''):
        temp_latex_file = r"C:\Nishkal\HooHacks 2024\AutoNote\Real-Time-Object-Detection-With-OpenCV\tmp\created.tex"
        with open(temp_latex_file,'w') as file:
            file.write(latex_content)

        output = subprocess.run(['pdflatex', '-interaction=nonstopmode','-output-directory',r"C:\Nishkal\HooHacks 2024\AutoNote\Real-Time-Object-Detection-With-OpenCV\tmp", temp_latex_file])
        
        pdf_path =  r"C:\Nishkal\HooHacks 2024\AutoNote\Real-Time-Object-Detection-With-OpenCV\tmp\created.pdf"
        return pdf_path
